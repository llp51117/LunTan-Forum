    ...
    <style>
        ...
        * {
        ...
        .shang1 {
            width: 100%;
            height: 150px;
            background: linear-gradient(135deg, #a2badc 0%, #d27aa1 100%);
            display: flex;
        ...
        .btn-zhuce {
            ...
            width: 100%;
            height: 65px;
            background: linear-gradient(135deg, #c27bc7 0%, #85a5ce 100%);
            color: white;
            font-size: 20px;
            font-weight: 600;
            cursor: pointer;
        ...
        .btn-zhuce:hover {
            background: linear-gradient(135deg, #5aadaa 0%, #953a93 100%);
